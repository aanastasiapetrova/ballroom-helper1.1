...
def get_kid_diploma(spacing=1, participant_name='', participant_id='', competition_name='', result=''):
    ...
    pdf.ln(10)
    pdf.cell(pdf.w-20, 10, f'за участие в промежуточной аттестации школы танцев "Олимп"', border=0, align='C')
    pdf.ln(10)
